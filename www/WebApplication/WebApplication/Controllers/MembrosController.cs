...
namespace WebApplication.Controllers
{
    public class MembrosController : Controller
    {
        ...
        public MembrosController(BdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Tel")] Membro membro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Tel")] Membro membro)
        {
            if (id != membro.Id)
            {
                return NotFound();
